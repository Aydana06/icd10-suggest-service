...
Систем нь үндсэн UI болгож веб хуудас (http://localhost:8080/api → index.html) ашигладаг. Нэмэлтээр, локал хөгжүүлэлтэд зориулсан Swing desktop клиент байгаа бөгөөд DESKTOP_UI_ENABLED=true тохируулсан үед л нээгдэнэ.
...
Хэрэгжүүлсэн ICD-10 онош санал болгох систем нь хэрэглэгчийн оношийн нэр, түлхүүр үг эсвэл кодыг оруулан хайлт хийхээс гадна оношийн ангиллын түвшингээр шүүлтүүр ашиглан хайлтыг нарийвчлах боломжийг бүрдүүлсэн. Ингэснээр ICD-10 оношийн олон тооны мэдээллийн дундаас шаардлагатай оношийг илүү хялбар, хурдан олох боломжтой болсон.

Зөвхөн оношийн нэр эсвэл түлхүүр үгээр хайлт хийх үед тухайн түлхүүр үгтэй холбоотой оношийн жагсаалтыг систем харуулна. Харин илэрцийн тоо их байгаа тохиолдолд хэрэглэгч нэмэлт шүүлтүүр ашиглан хайлтын үр дүнг нарийвчлах боломжтой.
![Зураг 1. Түлхүүр үгээр онош хайсан үр дүн](images/key_word.png)

Дараагийн түвшинд ерөнхий төрөл (Chapter)-ийг сонгон хайлт хийх боломжтой. Жишээлбэл, хоол боловсруулах тогтолцооны өвчнийг сонгосноор зөвхөн тухайн бүлэгт хамаарах оношнуудыг шүүн харуулах бөгөөд энэ нь шаардлагагүй бусад ангиллын оношнуудыг хасаж, хайлтын хүрээг багасгана.

![Зураг 2. Ерөнхий төрлийн шүүлтүүр ашиглан онош хайсан үр дүн](images/chapter.png)

Мөн хайлтыг ерөнхий төрөл болон төрөл (Category) гэсэн дараагийн түвшнээр нарийвчлах боломжтой. Тухайн ангиллыг сонгосноор зөвхөн сонгосон бүлэгт хамаарах оношнуудыг харуулж, хэрэглэгчийн хайж буй оношид хүрэх алхмыг багасгана.

![Зураг 3. Ерөнхий төрөл болон төрлөөр нарийвчлан хайсан үр дүн](images/category.png)

Үүнээс гадна систем нь дэд төрөл (Subcategory)-өөр хайлтыг цааш нарийвчлах боломжийг олгож, ICD-10 ангиллын шаталсан бүтцийг ашиглан оношийн мэдээллийг шүүн харах боломжийг бүрдүүлсэн.

Хайлтын үр дүнд оношийн ICD-10 код, оношийн нэр болон холбогдох нэмэлт мэдээлэл харагдана. Хэрэглэгч илэрцүүдээс тохирох оношийг сонгож, сонгосон оношийг системд баталгаажуулах боломжтой. Жишээлбэл, зурагт K86.2 – Нойр булчирхайн уйланхай онош сонгогдсон байдлаар харагдаж байна.

![Зураг 4. Ерөнхий төрөл, төрөл, дэд төрлөөр нарийвчлан хайсан үр дүн ](images/all_category.png)

Ийнхүү хэрэгжүүлсэн систем нь ICD-10 оношийн мэдээллийг түлхүүр үг → ерөнхий төрөл → төрөл → дэд төрөл гэсэн шаталсан байдлаар шүүн хайх боломжийг олгож байгаа бөгөөд олон тооны оношийн мэдээллийн дундаас шаардлагатай оношийг олох үйл явцыг хялбаршуулсан. Мөн хайлтын үр дүнг хязгаарлах, тохирох оношийг сонгох боломжтой болсон нь оношийн мэдээлэлтэй ажиллах хэрэглэгчийн үйл ажиллагааг илүү ойлгомжтой, зохион байгуулалттай болгоход чиглэсэн.